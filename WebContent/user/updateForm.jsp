			...
			<div class="panel-body">
				<ul>
					<li class="form-inline"><label>이름</label> : <input type="text"
						class="form-control" placeholder="이름을 입력해주세요" value="이름1">
					</li>
					<br />
					...
					<li class="form-inline"><label>비밀번호</label> : <input
						...
						value="비밀번호1"></li>
					<br />
					<li class="form-inline"><label>전화번호</label> : <select name=""
						id="" class="form-control">
							<option value="">010</option>
							<option value="">011</option>
					</select> - <input type="text" class="form-control" value="1234"> -
						<input type="text" class="form-control" value="1234"></li>
					<br />
					<li class="form-inline"><label>이메일</label> : <input
						type="text" class="form-control" placeholder="이메일" value="skdjfs">
