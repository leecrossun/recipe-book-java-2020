...
<body>
	...
	<div class="container recipe">
		...
		<div class="material sub-container">
			...
			<form name="form" method="POST"
				action="<c:url value='/recipe/view'> <c:param name='recipeId' value='${recipe.recipeId}'/> </c:url>">
				...
				<input type="text" name="serving" value="${servingString}" /> <label>인분
					조리</label>
			...
			<table>
				...
				<c:forEach var="ingredient" items="${rcpIng}">
					<tr>
						...
						<td><c:if test="${ingredient.amount ne 0}">
	...
	<div class="container" style="align-items: center; text-align: center;">
		<div class="sub-container" style="margin: 0px auto;">
			...
			<form class="servingSelect" name="form" method="POST"
				action="<c:url value='/review/create'><c:param name='recipeId' value='${recipe.recipeId}'/></c:url>">
				...
				<textarea placeholder="후기를 작성해주세요"
					style="width: 700px; height: 70px;" class="form" name="content"></textarea>
				<br>
				<div class="button-box">
				...
				<p>
					...
					<c:if test="${review.userId eq sessionScope.userId}">
						<a class="btn"
							...
							onClick="return removeMsgView()">삭제</a>
					</c:if>
				</p>
			</div>
		</c:forEach>
