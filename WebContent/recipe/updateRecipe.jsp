				...
				<table>
					<tr>
						...
						<td width="700px"><input name="recipeName" type="text" class="form"
							style="width: 90%;" placeholder="레시피명을 적어주세요" value="${recipe.recipeName }"></td>
					</tr>
					<tr>
						<td>한줄 설명</td>
					...
					<tr>
						<td>음식 나라명</td>
						<td><input name="nation" type="text" class="form" placeholder="나라 입력" value="${recipe.nation }"></td>
					</tr>
					...
					<tr>
						...
						<td style="border:none;">
							<table id="addTable"  class="stepTable" style="border:none;">
								...
								<input class="form" type="text" name="stepList" style="width:350px; height:20px;" value="${step.content }">
								<input type="button" value="삭제"  class="btn" onClick="removeRow()" style="cursor:hand">
								</c:forEach>
							</table>
