				...
				<table>
					<tr>
						...
						<td width="700px"><input name="recipeName" type="text" class="form" style="width: 90%;"
								placeholder="레시피명을 적어주세요" value="${recipe.recipeName }"></td>
					</tr>
					<tr>
						<td>한줄 설명</td>
						<td><input name="summary" type="text" class="form" style="width: 90%;"
								placeholder="레시피를 한줄로 설명해주세요" value="${recipe.summary }"></td>
					</tr>
					<tr>
						<td>음식 사진</td>
					...
					<tr>
						...
						<c:forEach var="ing" items="${rcpIng}">
							<input name="ingredient" type="text" class="form" value="${ing.ingredientName }">
						</c:forEach>
					</tr>
					<tr>
						<td>음식 나라명</td>
						<td><input name="nation" type="text" class="form" placeholder="나라 입력" value="${recipe.nation }">
						</td>
					</tr>
					...
					<tr>
						<td>요리난이도</td>
						<td>
							<input name="difficulty" id="difficulty" type="text" value="${recipe.difficulty }">
					...
					<tr>
						...
						<td style="border:none;">
							<table id="addTable" class="stepTable" style="border:none;">
								<c:forEach var="step" items="${rcpStep}">
									<input class="form" type="text" name="stepList" style="width:350px; height:20px;"
										value="${step.content }">
									<input type="button" value="삭제" class="btn" onClick="removeRow()"
										style="cursor:hand">
								</c:forEach>
							</table>
					...
					<tr>
						<td colspan="2">
							<div class="button-box">
								<input type="button" class="btn" onClick="frmCheck()" value="레시피수정">
							</div>
						</td>
					</tr>
				</table>
